...
IntVURow: TypeAlias = tuple[int, int]
FloatVURow: TypeAlias = tuple[float]
AnyVURow: TypeAlias = IntVURow | FloatVURow  # type: ignore[operator] #python/typeshed#4819
...
AnyVUMat: TypeAlias = tuple[
    IntVURow, Unpack[tuple[AnyVURow, ...]]  # type: ignore[misc] # python/mypy#12280 # TODO: Unpack -> * after 3.11
]
...
AnyIntVUMat: TypeAlias = tuple[IntVURow, ...]
